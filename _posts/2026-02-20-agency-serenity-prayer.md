...
<div class="blog-chart">
  <img src="/assets/images/serenity-prayer-flowchart.jpg"
       alt="Flow chart based on the Serenity Prayer asking: “Is this under my control?” If yes, take action. If no, practice grief and acceptance before refocusing on what you can change."
       loading="lazy">
  <p class="image-caption">The Serenity Prayer as a flow chart</p>
</div>
...
That question is harder than it sounds (hence “the wisdom to know the difference”). We desperately want more things to be controllable than actually are. There are feelings here. Disappointment. Anger. Sometimes panic.
...
Action builds **self-efficacy**. And self-efficacy is quietly one of the most powerful antidepressants we have.
...
[The NeuroAffective Relational Model (NARM)](/about/#how-I-work), a framework I’ve been loving lately, centers adult agency as a core healing mechanism.
...
When they fixate exclusively on what is outside their control, their world shrinks.
